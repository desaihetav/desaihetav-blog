...
If you like my content, follow me on [Twitter](https://twitter.com/desaihetav) and subscribe to my newsletter so that you don't miss out on updates whenever I post something new.

<iframe
  src="https://desaihetav.substack.com/embed"
  width="100%"
  height="290"
  style="border:0px solid #EEE; background:#F3F4F6; border-radius: 0.5rem;"
  frameborder="0"
  scrolling="no"
></iframe>
